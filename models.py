...
class ClientFrontHouseRecord(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, server_default=func.uuid_generate_v4())
    client_id = Column(UUID(as_uuid=True), ForeignKey("clients.ID", ondelete="CASCADE"), nullable=False)
    home_visible_from_street = Column(Boolean, default=False, nullable=True)
    exterior_lighting = Column(Boolean, default=False, nullable=True)
    surveillance_cameras = Column(Boolean, default=False, nullable=True)
    motion_sensors_alarms = Column(Boolean, default=False, nullable=True)
    ground_floor_windows_accessible = Column(Boolean, default=False, nullable=True)
    bars_locks_reinforced_glass = Column(Boolean, default=False, nullable=True)
...
class ClientBackHouseRecord(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, server_default=func.uuid_generate_v4())
    client_id = Column(UUID(as_uuid=True), ForeignKey("clients.ID", ondelete="CASCADE"), nullable=False)
    rear_entry_door = Column(Boolean, default=False, nullable=True)
    ground_floor_windows_accessible = Column(Boolean, default=False, nullable=True)
    rear_exterior_lighting = Column(Boolean, default=False, nullable=True)
    bars_locks_reinforced_glass = Column(Boolean, default=False, nullable=True)
    gate_fence = Column(Boolean, default=False, nullable=True)
    obstruction_of_view = Column(String, nullable=True)
    surveillance_cameras = Column(Boolean, default=False, nullable=True)
